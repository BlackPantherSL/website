...
import { FaGithub, FaInstagram, FaWhatsapp, FaLinkedin, FaYoutube, FaFacebook } from 'react-icons/fa'
    ...
    <div className="relative flex min-h-full w-full flex-col items-center justify-center">
      <div className="relative flex items-center justify-center py-3">
        <h1 className="relative flex-1">
          ...
          <span className=" z-10 block text-[calc(1.825rem+6.9vw)] font-bold leading-none">BlackPanther</span>{' '}
          <span className="grid grid-cols-2 justify-items-end">
            <span className="block"></span>
            <span className="block text-sm opacity-90">
              A FULL STACK
              <br /> GRAPHIC DESIGNER AND  VIDEO EDITOR
            </span>
          </span>
        </h1>
        ...
        <a href={SOCIALS.WA} aria-label="WhatsApp" target="_blank" rel="noopener" className="mx-2 block p-2 opacity-80 hover:opacity-95">
          ...
          <a href={SOCIALS.FB} aria-label="Facebook" target="_blank" rel="noopener" className="mx-2 block p-2 opacity-80 hover:opacity-95">
            <FaFacebook size={20} />
          </a>
          <a href={SOCIALS.YT} aria-label="Youtube" target="_blank" rel="noopener" className="mx-2 block p-2 opacity-80 hover:opacity-95">
            <FaYoutube size={20} />
          </a>
